...
A clean and powerful text diff tool. Paste two texts and see exactly what changed — line by line, word by word, or character by character.

## ✨ Features

- Line, word, and char diff modes
